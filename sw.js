...
self.addEventListener('fetch', (e) => {
  ...
  // 非 GET 一概不插手：Cache API 的 match() 不支持 POST/DELETE，
  // 硬塞进下面的"缓存优先"分支会让请求落进 catch 回退、返回一个假的 index.html，
  // 调用方以为写成功了、其实根本没发出去。
